<template lang="pug">
    div.sign-up
        ...
        form(v-else).form.sign-up__form
            div.sign-up__column
                .form__line.form__line--v
                    label.form__label(for="first_name") Имя
                    input#first_name.sign-up__input.input(v-model="first_name" type="text")
                .form__line.form__line--v
                    label.form__label(for="last_name") Фамилия
                    input#last_name.sign-up__input.input(v-model="last_name" type="text")
            div.sign-up__column
                .form__line.form__line--v
                    label.form__label(for="username") Электронная почта / email
                    input#username.sign-up__input.input(v-model="username" type="email" autocomplete="off")
                .form__line.form__line--v
                    label.form__label(for="password") Пароль
                    input#password.sign-up__input.input(v-model="password" type="password" autocomplete="off")
                //.form__line.form__line--v
            ...
            div.sign-up__column
                .form__line.form__line--h
                    button.button.button--blue(@click.prevent="signUp")
