...
class Kama_Breadcrumbs {
    ...
    static $l10n = array(
        'home'       => 'Главная',
        'paged'      => '<span class="breadcrumbs__title">Страница %d</span>',
        '_404'       => 'Ошибка 404',
        'search'     => '<span class="breadcrumbs__title">Результаты поиска по запросу - <b>%s</b></span>',
...
//        'tax_tag'    => '%1$s из "%2$s" по тегу: <b>%3$s</b>',
    ...
    static $args = array(
        ...
        'title_patt'      => '<span class="breadcrumbs__title">%s</span>', // шаблон для последнего заголовка. Если включено: show_post_title или show_term_title
    ...
    function get_crumbs( $sep, $l10n, $args ){
        ...
        $arg->sep = '<span class="breadcrumbs__sep">'. $arg->sep .'</span>'; // дополним
